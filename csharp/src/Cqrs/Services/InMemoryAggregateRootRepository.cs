...
namespace Cqrs.Services
{
    public class InMemoryAggregateRootRepository : IAggregateRootRepository
    {
        ...
        public void Save(Guid aggregateId, int expectedVersion, IEnumerable<object> uncommitedEvents)
        {
            _eventStore.AppendToStream(aggregateId.ToString(), expectedVersion, uncommitedEvents);
        }
    }
}